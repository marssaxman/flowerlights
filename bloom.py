...
# Insert GPL v2 open source boilerplate here.

import opc, time, random, math
TWO_PI = math.pi * 2.0
	...
	def render(self, t):
		...
		for strip in range(7):
			for pixel in range(8):
				...
				self._display.set(strip, pixel, light)
...
flower = Flower(display, time.clock())
print str(flower)
